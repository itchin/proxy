...
var file_grpc_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x31, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12,
	...
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x1e, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x38, 0x0a, 0x04, 0x47, 0x72, 0x70, 0x63, 0x12, 0x30,
	0x0a, 0x07, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x12, 0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x42, 0x2a, 0x0a, 0x16, 0x69, 0x6f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x65, 0x78, 0x61, 0x6d,
	0x70, 0x6c, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x42, 0x05, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x50, 0x01, 0x5a, 0x07, 0x2e, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_grpc_proto_depIdxs = []int32{
	0, // 0: proto.Grpc.process:input_type -> proto.Request
	1, // 1: proto.Grpc.process:output_type -> proto.Response
...
type GrpcClient interface {
	Process(ctx context.Context, opts ...grpc.CallOption) (Grpc_ProcessClient, error)
}
...
func (c *grpcClient) Process(ctx context.Context, opts ...grpc.CallOption) (Grpc_ProcessClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Grpc_serviceDesc.Streams[0], "/proto.Grpc/process", opts...)
	if err != nil {
		return nil, err
	}
	x := &grpcProcessClient{stream}
	return x, nil
}

type Grpc_ProcessClient interface {
	Send(*Request) error
	Recv() (*Response, error)
	grpc.ClientStream
}

type grpcProcessClient struct {
	grpc.ClientStream
}

func (x *grpcProcessClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *grpcProcessClient) Recv() (*Response, error) {
	m := new(Response)
...
type GrpcServer interface {
	Process(Grpc_ProcessServer) error
}
...
func (*UnimplementedGrpcServer) Process(Grpc_ProcessServer) error {
...
func _Grpc_Process_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GrpcServer).Process(&grpcProcessServer{stream})
}

type Grpc_ProcessServer interface {
	Send(*Response) error
	Recv() (*Request, error)
	grpc.ServerStream
}

type grpcProcessServer struct {
	grpc.ServerStream
}

func (x *grpcProcessServer) Send(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *grpcProcessServer) Recv() (*Request, error) {
	m := new(Request)
